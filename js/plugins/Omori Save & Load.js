...
Window_OmoriFileInformation.prototype.refresh = function() {
  ...
  if (valid) {
    ...
    // Draw Actor Name
	this.contents.fontSize = LanguageManager.getMessageData("XX_BLUE.Window_OmoriFileInformation").actor_name_fontsize;
	let actor_name_offset = LanguageManager.getMessageData("XX_BLUE.Window_OmoriFileInformation").actor_name_offset;
    this.contents.drawText(actor.name, 118 + actor_name_offset[0], 30 + actor_name_offset[1], 100, 24);
...
Window_OmoriFileCommand.prototype.windowWidth = function () { return 150; };
...
Window_OmoriFilePrompt.prototype.makeCommandList = function () {
  this.addCommand(LanguageManager.getMessageData("XX_GENERAL.choice_wile").text, 'ok');
  this.addCommand(LanguageManager.getMessageData("XX_GENERAL.choice_wile_ala").text, 'cancel');
};
//=============================================================================
// * Refresh
//=============================================================================
