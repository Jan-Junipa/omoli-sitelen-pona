...
//=============================================================================
Game_Interpreter.prototype.showNameInputWindows = function(name = "", max = 5, wait = true) {
...
Window_OmoriNameInputName.prototype.add = function(character) {
  ...
  console.log(this._maxCharacters)
...
Window_OmoriInputLetters.prototype.onNameOk = function() {
  ...
  if (text.length > 0) {
    ...
    if (_TDS_.NameInput.params.nameVariableID > 0) {
      $gameVariables.setValue(_TDS_.NameInput.params.nameVariableID, fixName(text));
    };
  } else {
    this.playBuzzerSound();
  };
...
class VirtualKeyboard extends Window_Selectable {
  ...
  processOk() {
	...
	if(character.startsWith("{nimi")) {
		if(character == "{nimiDefault}") {
			SoundManager.playOk()
		...
		this._layoutType = character.substring(1,character.length-1);
		this.determineLayoutData()
		this.refresh()
		return;
	}
...
VirtualKeyboard.EN = {
  default: [
	  "{nimiA} {nimiE} {nimiI} {nimiJ} {space} {space} {bksp}",
	  "{nimiK} {nimiL} {nimiM} {nimiN} {space} {space} {space}",
	  "{nimiO} {nimiP} {nimiS} {nimiT} {space} {space} {space}",
	  "{nimiU} {nimiW} ㊉ ㊊ {larrow} {rarrow} {confirm}",
  ],
  anteNimi: [
	  "{nimiA} {nimie} {nimiI} {nimiJ} {nimiK} {nimiL} {space} {space} {space} {bksp} {lockDefault}",
	  "{nimiM} {nimiN} {nimiO} {nimiP} {nimiS} {nimiT}",
	  "{nimiU} {nimiW}",
...
"{space} {space} {space} ㊉ ㊊ {larrow} {rarrow} {confirm}",
],
nimiE: [
"㈉ ㈊ ㊃ ㈋ {bksp} {nimiDefault}",
"{space} {space} {space} {space} {space} {space}",
"{space} {space} {space} {space} {space} {space}",
"{space} ㊉ ㊊ {larrow} {rarrow} {confirm}",
],
nimiI: [
"㈌ ㈍ ㈎ ㈏ {bksp} {nimiDefault}",
"{space} {space} {space} {space} {space} {space}",
...
"{space} {space} {space} {space} {space} {space} {space}",
"{space} {space} ㊉ ㊊ {larrow} {rarrow} {confirm}",
],
nimiK: [
"㈔ ㈕ ㈖ ㈗ ㈘ ㈙ {bksp} {nimiDefault}",
"㊀ ㈚ ㉹ ㉻ ㈛ ㈜ {space} {space}",
...
VirtualKeyboard["{nimiA}"] = "a"
VirtualKeyboard["{nimiE}"] = "e"
VirtualKeyboard["{nimiI}"] = "i"
VirtualKeyboard["{nimiJ}"] = "j"
VirtualKeyboard["{nimiK}"] = "k"
VirtualKeyboard["{nimiL}"] = "l"
VirtualKeyboard["{nimiM}"] = "m"
VirtualKeyboard["{nimiN}"] = "n"
VirtualKeyboard["{nimiO}"] = "o"
VirtualKeyboard["{nimiP}"] = "p"
VirtualKeyboard["{nimiS}"] = "s"
VirtualKeyboard["{nimiT}"] = "t"
VirtualKeyboard["{nimiU}"] = "u"
VirtualKeyboard["{nimiW}"] = "w"
VirtualKeyboard["{nimiDefault}"] = "aei"
VirtualKeyboard["{N/A}"] = " "
