...
Scene_OmoriTitleScreen.prototype.createVersionText = function() {
  ...
  this._gameVersion = new Sprite(new Bitmap(Math.ceil(Graphics.boxWidth / 2), 32))
  ...
  this._gameVersion.bitmap.drawText("V1.0.8 toki pona demo 0.1", padding ,padding , this._gameVersion.bitmap.width, 16, "left");
}
